...
yellow_boundary = [np.array([35,147,193]),np.array([55,230,255])]
...
cap = cv2.VideoCapture('/Users/akshatkg/Desktop/Inter-IIT/frames_circ/circle10.avi')
error_x = []
error_y = []
error_z = []
actual_x = []
...
while ret:
    ...
    if len(points) == 4:
        ...
        print('n1: ',n1)
        print('mod n1: ', math.sqrt(n1[0]*n1[0] + n1[1]*n1[1] + n1[2]*n1[2]))
        print('n2: ',n2)
        print('mod n2: ', math.sqrt(n2[0]*n2[0] + n2[1]*n2[1] + n2[2]*n2[2]))
        # print('nf: ', nf)
