function [final_waypoints] = path_planning_test(initial_q, collision_free_ik_solutions)
...
final_waypoints = zeros(6, 0);
disp(num_possible_paths)
...
%     disp("collision check")
    ...
    if(~collision)
        final_waypoints = [final_waypoints, waypoints_to_check];   
    end
