...
%% plot
% load('q.mat')
plot(time_sequence1, q1(2, :),'LineWidth',1);
hold on
plot(time_sequence1,q1(3, :),'LineWidth',1);
hold on
plot(time_sequence1, q1(4, :),'LineWidth',1);
hold on
plot(time_sequence1,q1(5, :),'LineWidth',1);
hold on
plot(time_sequence1,q1(6, :),'LineWidth',1);
hold on
